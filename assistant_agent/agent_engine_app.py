...
from assistant_agent.utils.deployment import (
    parse_env_vars,
    print_deployment_success,
    write_deployment_metadata,
)
from assistant_agent.utils.gcs import create_bucket_if_not_exists
from assistant_agent.utils.tracing import CloudTraceLoggingSpanExporter
from assistant_agent.utils.typing import Feedback
...
def deploy_agent_engine_app(
    ...
    artifacts_bucket_name = f"{project}-adk-agents-logs"
